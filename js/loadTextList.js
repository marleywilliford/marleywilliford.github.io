...
function listTexts(sourceXML) {
    ...
    var licsenseText = document.getElementById("license");
    licsenseText.innerText = sourceXML.getElementsByTagName("availability")[0].children[0].innerHTML;
    licsenseText.setAttribute("href", sourceXML.getElementsByTagName("availability")[0].children[0].attributes[0].nodeValue);
